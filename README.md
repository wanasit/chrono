...
- In addition to English, Chrono supports the following languages: `ar`, `fi`, `fr`, `it`, `ja`, `nl`, `ru`, `uk`, and `vi`. We also have partial support for `de`, `es`, `pt`, `sv`, `zh.hans`, and `zh.hant`.
