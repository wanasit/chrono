...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/FR"),DAYS_OFFSET=util.WEEKDAY_OFFSET,PATTERN=new RegExp("(\\W|^)(?:(Dimanche|Lundi|Mardi|mercredi|Jeudi|Vendredi|Samedi|Dim|Lun|Mar|Mer|Jeu|Ven|Sam)\\s*,?\\s*)?([0-9]{1,2})(?:\\s*(?:au|\\-|\\–|jusqu'au?|\\s)\\s*([0-9]{1,2})(?:er)?)?\\s*(?:de)?\\s*(Jan(?:vier|\\.)?|Fév(?:rier|\\.)?|Mars|Avr(?:il|\\.)?|Mai|Juin|Juil(?:let|\\.)?|Ao[uû]t|Sept(?:embre|\\.)?|Oct(?:obre|\\.)?|Nov(?:embre|\\.)?|déc(?:embre|\\.)?)(?:\\s*(\\s*[0-9]{2,4}(?![^\\s]\\d))(\\s*AC)?)?(?=\\W|$)","i"),WEEKDAY_GROUP=2,DATE_GROUP=3,DATE_TO_GROUP=4,MONTH_NAME_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,t,a){var s=new ParsedResult({text:t[0].substr(t[1].length,t[0].length-t[1].length),index:t.index+t[1].length,ref:r}),n=t[MONTH_NAME_GROUP];n=util.MONTH_OFFSET[n.toLowerCase()];var i=t[DATE_GROUP];i=parseInt(i);var E=null;if(t[YEAR_GROUP]&&(E=t[YEAR_GROUP],E=parseInt(E),t[YEAR_BE_GROUP]?E-=543:100>E&&(E+=2e3)),E)s.start.assign("day",i),s.start.assign("month",n),s.start.assign("year",E);else{var d=moment(r);d.month(n-1),d.date(i),d.year(moment(r).year());var u=d.clone().add(1,"y"),m=d.clone().add(-1,"y");Math.abs(u.diff(moment(r)))<Math.abs(d.diff(moment(r)))?d=u:Math.abs(m.diff(moment(r)))<Math.abs(d.diff(moment(r)))&&(d=m),s.start.assign("day",i),s.start.assign("month",n),s.start.imply("year",d.year())}if(t[WEEKDAY_GROUP]){var R=t[WEEKDAY_GROUP];R=util.WEEKDAY_OFFSET[R.toLowerCase()],s.start.assign("weekday",R)}return t[DATE_TO_GROUP]&&(s.end=s.start.clone(),s.end.assign("day",parseInt(t[DATE_TO_GROUP]))),s.tags.FRMonthNameLittleEndianParser=!0,s}};
},{"../../result":48,"../../utils/FR":51,"../parser":37,"moment":1}],26:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)(?:((?:dimanche|dim|lundi|lun|mardi|mar|mercredi|mer|jeudi|jeu|vendredi|ven|samedi|sam|le))\\s*\\,?\\s*)?([0-9]{1,2})[\\/\\.\\-]([0-9]{1,2})(?:[\\/\\.\\-]([0-9]{4}|[0-9]{2}))?(\\W|$)","i"),DAYS_OFFSET={dimanche:0,dim:0,lundi:1,lun:1,mardi:2,mar:2,mercredi:3,mer:3,jeudi:4,jeu:4,vendredi:5,ven:5,samedi:6,sam:6},OPENNING_GROUP=1,ENDING_GROUP=6,WEEKDAY_GROUP=2,DAY_GROUP=3,MONTH_GROUP=4,YEAR_GROUP=5;exports.Parser=function(e){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,a,t){if("/"==a[OPENNING_GROUP]||"/"==a[ENDING_GROUP])return void(a.index+=a[0].length);var n=a.index+a[OPENNING_GROUP].length,e=a[0].substr(a[OPENNING_GROUP].length,a[0].length-a[ENDING_GROUP].length),s=new ParsedResult({text:e,index:n,ref:r});if(!e.match(/^\d\.\d$/)&&!e.match(/^\d\.\d{1,2}\.\d{1,2}$/)&&(a[YEAR_GROUP]||!(a[0].indexOf("/")<0))){var i=a[YEAR_GROUP]||moment(r).year()+"",d=a[MONTH_GROUP],P=a[DAY_GROUP];if(P=parseInt(P),d=parseInt(d),i=parseInt(i),(1>d||d>12)&&d>12){if(!(P>=1&&12>=P&&d>=13&&31>=d))return null;var R=d;d=P,P=R}return 1>P||P>31?null:(100>i&&(i>50?i=i+2500-543:i+=2e3),s.start.assign("day",P),s.start.assign("month",d),s.start.assign("year",i),a[WEEKDAY_GROUP]&&s.start.assign("weekday",DAYS_OFFSET[a[WEEKDAY_GROUP].toLowerCase()]),s.tags.FRSlashDateFormatParser=!0,s)}}};
