...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,FIRST_REG_PATTERN=new RegExp("(^|\\s|T)(?:(?:at|from)\\s*)?(\\d{1,4}|noon|midnight)(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),SECOND_REG_PATTERN=new RegExp("^\\s*(\\-|\\–|\\~|\\〜|to|\\?)\\s*(\\d{1,4})(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),HOUR_GROUP=2,MINUTE_GROUP=3,SECOND_GROUP=4,AM_PM_HOUR_GROUP=5;exports.Parser=function(){Parser.call(this),this.pattern=function(){return FIRST_REG_PATTERN},this.extract=function(e,r,t,n){if(t.index>0&&e[t.index-1].match(/\w/))return null;var s=moment(r),a=new ParsedResult;a.ref=r,a.index=t.index+t[1].length,a.text=t[0].substring(t[1].length),a.tags.ENTimeExpressionParser=!0,a.start.imply("day",s.date()),a.start.imply("month",s.month()+1),a.start.imply("year",s.year());var i=0,l=0,u=-1;if(null!=t[SECOND_GROUP]){var R=parseInt(t[SECOND_GROUP]);if(R>=60)return null;a.start.assign("second",R)}if("noon"==t[HOUR_GROUP].toLowerCase()?(u=1,i=12):"midnight"==t[HOUR_GROUP].toLowerCase()?(u=0,i=0):i=parseInt(t[HOUR_GROUP]),null!=t[MINUTE_GROUP]?l=parseInt(t[MINUTE_GROUP]):i>100&&(l=i%100,i=parseInt(i/100)),l>=60)return null;if(i>24)return null;if(i>=12&&(u=1),null!=t[AM_PM_HOUR_GROUP]){if(i>12)return null;var P=t[AM_PM_HOUR_GROUP][0].toLowerCase();"a"==P&&(u=0,12==i&&(i=0)),"p"==P&&(u=1,12!=i&&(i+=12))}if(a.start.assign("hour",i),a.start.assign("minute",l),u>=0&&a.start.assign("meridiem",u),t=SECOND_REG_PATTERN.exec(e.substring(a.index+a.text.length)),!t)return a.text.match(/^\d+$/)?null:a;if(t[0].match(/^\s*(\+|\-)\d{3,4}$/))return a;null==a.end&&(a.end=a.start.clone());var i=0,l=0,u=-1;if(null!=t[SECOND_GROUP]){var R=parseInt(t[SECOND_GROUP]);if(R>=60)return null;a.end.assign("second",R)}if(i=parseInt(t[2]),null!=t[MINUTE_GROUP]){if(l=parseInt(t[MINUTE_GROUP]),l>=60)return a}else i>100&&(l=i%100,i=parseInt(i/100));if(l>=60)return null;if(i>24)return null;if(i>=12&&(u=1),null!=t[AM_PM_HOUR_GROUP]){if(i>12)return null;"a"==t[AM_PM_HOUR_GROUP][0].toLowerCase()&&(u=0,12==i&&(i=0,a.end.isCertain("day")||a.end.imply("day",a.end.get("day")+1))),"p"==t[AM_PM_HOUR_GROUP][0].toLowerCase()&&(u=1,12!=i&&(i+=12)),a.start.isCertain("meridiem")||(0==u?(a.start.imply("meridiem",0),12==a.start.get("hour")&&a.start.assign("hour",0)):(a.start.imply("meridiem",1),12!=a.start.get("hour")&&a.start.assign("hour",a.start.get("hour")+12)))}return i>=12&&(u=1),a.text=a.text+t[0],a.end.assign("hour",i),a.end.assign("minute",l),u>=0&&a.end.assign("meridiem",u),a}};
