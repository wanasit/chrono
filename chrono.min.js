...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/EN"),PATTERN=new RegExp("(\\W|^)(?:on\\s*?)?(?:(Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun|Mon|Tue|Wed|Thu|Fri|Sat)\\s*,?\\s*)?([0-9]{1,2})(?:st|nd|rd|th)?(?:\\s*(?:to|\\-|\\–|until|through|till|\\s)\\s*([0-9]{1,2})(?:st|nd|rd|th)?)?\\s*(?:of)?\\s*(Jan(?:uary|\\.)?|Feb(?:ruary|\\.)?|Mar(?:ch|\\.)?|Apr(?:il|\\.)?|May|Jun(?:e|\\.)?|Jul(?:y|\\.)?|Aug(?:ust|\\.)?|Sep(?:tember|\\.)?|Oct(?:ober|\\.)?|Nov(?:ember|\\.)?|Dec(?:ember|\\.)?)(?:,?\\s*([0-9]{1,4}(?![^\\s]\\d))(\\s*(?:BE|AD|BC))?)?(?=\\W|$)","i"),WEEKDAY_GROUP=2,DATE_GROUP=3,DATE_TO_GROUP=4,MONTH_NAME_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,t,a,r){var s=new ParsedResult({text:a[0].substr(a[1].length,a[0].length-a[1].length),index:a.index+a[1].length,ref:t}),n=a[MONTH_NAME_GROUP];n=util.MONTH_OFFSET[n.toLowerCase()];var i=a[DATE_GROUP];i=parseInt(i);var u=null;if(a[YEAR_GROUP])if(u=a[YEAR_GROUP],u=parseInt(u),a[YEAR_BE_GROUP])/BE/i.test(a[YEAR_BE_GROUP])?u-=543:/BC/i.test(a[YEAR_BE_GROUP])&&(u=-u);else{if(10>u)return null;100>u&&(u+=2e3)}if(u)s.start.assign("day",i),s.start.assign("month",n),s.start.assign("year",u);else{var E=moment(t);E.month(n-1),E.date(i),E.year(moment(t).year());var d=E.clone().add(1,"y"),o=E.clone().add(-1,"y");Math.abs(d.diff(moment(t)))<Math.abs(E.diff(moment(t)))?E=d:Math.abs(o.diff(moment(t)))<Math.abs(E.diff(moment(t)))&&(E=o),s.start.assign("day",i),s.start.assign("month",n),s.start.imply("year",E.year())}if(a[WEEKDAY_GROUP]){var R=a[WEEKDAY_GROUP];R=util.WEEKDAY_OFFSET[R.toLowerCase()],s.start.assign("weekday",R)}return a[DATE_TO_GROUP]&&(s.end=s.start.clone(),s.end.assign("day",parseInt(a[DATE_TO_GROUP]))),s.tags.ENMonthNameLittleEndianParser=!0,s}};
},{"../../result":48,"../../utils/EN":49,"../parser":37,"moment":1}],8:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/EN"),PATTERN=new RegExp("(\\W|^)(?:(?:on\\s*?)?(Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun\\.?|Mon\\.?|Tue\\.?|Wed\\.?|Thu\\.?|Fri\\.?|Sat\\.?)\\s*,?\\s*)?(Jan\\.?|January|Feb\\.?|February|Mar\\.?|March|Apr\\.?|April|May\\.?|Jun\\.?|June|Jul\\.?|July|Aug\\.?|August|Sep\\.?|Sept\\.?|September|Oct\\.?|October|Nov\\.?|November|Dec\\.?|December)\\s*([0-9]{1,2})(?:st|nd|rd|th)?\\s*(?:(?:to|\\-)\\s*([0-9]{1,2})(?:st|nd|rd|th)?\\s*)?(?:\\s*,?\\s*(?:([0-9]{4})\\s*(BE|AD|BC)?|([0-9]{1,4})\\s*(AD|BC))\\s*)?(?=\\W|$)(?!\\:\\d)","i"),WEEKDAY_GROUP=2,MONTH_NAME_GROUP=3,DATE_GROUP=4,DATE_TO_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7,YEAR_GROUP2=8,YEAR_BE_GROUP2=9;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,t,a,r){e.indexOf("5 May 12:00")>=0&&console.log(a);var s=new ParsedResult({text:a[0].substr(a[1].length,a[0].length-a[1].length),index:a.index+a[1].length,ref:t}),n=a[MONTH_NAME_GROUP];n=util.MONTH_OFFSET[n.toLowerCase()];var i=a[DATE_GROUP];i=parseInt(i);var E=null;if(a[YEAR_GROUP]||a[YEAR_GROUP2]){E=a[YEAR_GROUP]||a[YEAR_GROUP2],E=parseInt(E);var d=a[YEAR_BE_GROUP]||a[YEAR_BE_GROUP2];d?/BE/i.test(d)?E-=543:/BC/i.test(d)&&(E=-E):100>E&&(E+=2e3)}if(E)s.start.assign("day",i),s.start.assign("month",n),s.start.assign("year",E);else{var R=moment(t);R.month(n-1),R.date(i);var u=R.clone().add(1,"y"),o=R.clone().add(-1,"y");Math.abs(u.diff(moment(t)))<Math.abs(R.diff(moment(t)))?R=u:Math.abs(o.diff(moment(t)))<Math.abs(R.diff(moment(t)))&&(R=o),s.start.assign("day",i),s.start.assign("month",n),s.start.imply("year",R.year())}if(a[WEEKDAY_GROUP]){var O=a[WEEKDAY_GROUP];O=util.WEEKDAY_OFFSET[O.toLowerCase()],s.start.assign("weekday",O)}return a[DATE_TO_GROUP]&&(s.end=s.start.clone(),s.end.assign("day",parseInt(a[DATE_TO_GROUP]))),s.tags.ENMonthNameMiddleEndianParser=!0,s}};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,DAYS_OFFSET={dimanche:0,dim:0,lundi:1,lun:1,mardi:2,mar:2,mercredi:3,mer:3,jeudi:4,jeu:4,vendredi:5,ven:5,samedi:6,sam:6},PATTERN=new RegExp("(\\s|^)(?:(?:\\,|\\(|\\（)\\s*)?(?:(ce)\\s*)?("+Object.keys(DAYS_OFFSET).join("|")+")(?:\\s*(?:\\,|\\)|\\）))?(?:\\s*(dernier|prochain)\\s*)?(?=\\W|$)","i"),PREFIX_GROUP=2,WEEKDAY_GROUP=3,POSTFIX_GROUP=4;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,a,t){var s=a.index+a[1].length,e=a[0].substr(a[1].length,a[0].length-a[1].length),n=new ParsedResult({index:s,text:e,ref:r}),d=a[WEEKDAY_GROUP].toLowerCase(),i=DAYS_OFFSET[d];if(void 0===i)return null;var y=moment(r),l=a[PREFIX_GROUP],o=a[POSTFIX_GROUP];if(l||o){var P=l||o;P=P.toLowerCase(),"dernier"==P?y.day(i-7):"prochain"==P?y.day(i+7):"ce"==P&&y.day(i)}else{var m=y.day();t.forwardDatesOnly&&m>i?y.day(i+7):!t.forwardDatesOnly&&Math.abs(i-7-m)<Math.abs(i-m)?y.day(i-7):!t.forwardDatesOnly&&Math.abs(i+7-m)<Math.abs(i-m)?y.day(i+7):y.day(i)}return n.start.assign("weekday",i),n.start.imply("day",y.date()),n.start.imply("month",y.month()+1),n.start.imply("year",y.year()),n.tags.FRWeekdayParser=!0,n}};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/ZH-Hant.js"),PATTERN=new RegExp("(上|今|下|這|呢)?(?:個)?(?:星期|禮拜)("+Object.keys(util.WEEKDAY_OFFSET).join("|")+")"),PREFIX_GROUP=1,WEEKDAY_GROUP=2;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(a,r,e,t){var s=e.index;a=e[0];var n=new ParsedResult({index:s,text:a,ref:r}),d=e[WEEKDAY_GROUP],i=util.WEEKDAY_OFFSET[d];if(void 0===i)return null;var y=moment(r),u=e[PREFIX_GROUP],l=y.day();return"上"==u?y.day(i-7):"下"==u?y.day(i+7):"今"==u||"這"==u||"呢"==u?t.forwardDatesOnly&&l>i?y.day(i+7):y.day(i):t.forwardDatesOnly&&l>i?y.day(i+7):!t.forwardDatesOnly&&Math.abs(i-7-l)<Math.abs(i-l)?y.day(i-7):!t.forwardDatesOnly&&Math.abs(i+7-l)<Math.abs(i-l)?y.day(i+7):y.day(i),n.start.assign("weekday",i),n.start.imply("day",y.date()),n.start.imply("month",y.month()+1),n.start.imply("year",y.year()),n.tags.ZHHantWeekdayParser=!0,n}};
