...
var options=exports.options=require("./options");exports.parser=require("./parsers/parser"),exports.refiner=require("./refiners/refiner"),exports.Parser=exports.parser.Parser,exports.Refiner=exports.refiner.Refiner,exports.Filter=exports.refiner.Filter,exports.ParsedResult=require("./result").ParsedResult,exports.ParsedComponents=require("./result").ParsedComponents;var Chrono=function(o){o=o||exports.options.casualOption(),this.option=o,this.parsers=new Object(o.parsers),this.refiners=new Object(o.refiners)};Chrono.prototype.parse=function(o,e,r){e=e||new Date,r=r||{},r.forwardDate=r.forwardDate||r.forwardDate;var s=[];return this.parsers.forEach(function(t){var n=t.execute(o,e,r);s=s.concat(n)}),s.sort(function(o,e){return o.index-e.index}),this.refiners.forEach(function(e){s=e.refine(o,s,r)}),s},Chrono.prototype.parseDate=function(o,e,r){var s=this.parse(o,e,r);if(s.length>0){var t=-1,n=!1;return s.forEach(function(o){if(!n&&o.start.isCertain("meridiem")){t=o.start.get("meridiem");var e=s[0].start.get("hour");1===t&&e<12&&s[0].start.assign("hour",e+12),n=!0,s[0].start.assign("meridiem",t)}}),s[0].start.date()}return null},exports.Chrono=Chrono,exports.strict=new Chrono(options.strictOption()),exports.casual=new Chrono(options.casualOption()),exports.en=new Chrono(options.mergeOptions([options.en.casual,options.commonPostProcessing])),exports.en_GB=new Chrono(options.mergeOptions([options.en_GB.casual,options.commonPostProcessing])),exports.de=new Chrono(options.mergeOptions([options.de.casual,options.en,options.commonPostProcessing])),exports.es=new Chrono(options.mergeOptions([options.es.casual,options.en,options.commonPostProcessing])),exports.fr=new Chrono(options.mergeOptions([options.fr.casual,options.en,options.commonPostProcessing])),exports.ja=new Chrono(options.mergeOptions([options.ja.casual,options.en,options.commonPostProcessing])),exports.parse=function(){return exports.casual.parse.apply(exports.casual,arguments)},exports.parseDate=function(){return exports.casual.parseDate.apply(exports.casual,arguments)};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)((this)?\s*(morning|afternoon|evening|noon|night))/i,TIME_MATCH=4;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(r,n,e,t){var r=e[0].substr(e[1].length),i=e.index+e[1].length,s=new ParsedResult({index:i,text:r,ref:n});return e[TIME_MATCH]||(TIME_MATCH=3),"afternoon"==e[TIME_MATCH]?(s.start.assign("meridiem",1),s.start.imply("hour",t.afternoon?t.afternoon:15)):"evening"==e[TIME_MATCH]?(s.start.assign("meridiem",1),s.start.imply("hour",t.evening?t.evening:18)):"morning"==e[TIME_MATCH]?(s.start.assign("meridiem",0),s.start.imply("hour",t.morning?t.morning:6)):"noon"==e[TIME_MATCH]?(s.start.assign("meridiem",1),s.start.imply("hour",t.noon?t.noon:12)):"night"==e[TIME_MATCH]&&(s.start.assign("meridiem",1),s.start.imply("hour",t.night?t.night:21)),s.tags.ENCasualTimeParser=!0,s}};
