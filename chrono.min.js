...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(today|tonight|tomorrow|tmr|yesterday|last\s*night|this\s*(morning|afternoon|evening))(?=\W|$)/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,r,e,a){var s=e.index,t=e[0],i=new ParsedResult({index:s,text:t,ref:r}),n=moment(r),o=n.clone(),m=t.toLowerCase();if("tonight"==m)i.start.imply("hour",22),i.start.imply("meridiem",1);else if("tomorrow"==m||"tmr"==m)n.hour()>4&&o.add(1,"day");else if("yesterday"==m)o.add(-1,"day");else if(m.match(/last\s*night/))i.start.imply("hour",0),n.hour()>6&&o.add(-1,"day");else if(m.match("this")){var d=e[2].toLowerCase();"afternoon"==d?i.start.imply("hour",15):"evening"==d?i.start.imply("hour",18):"morning"==d&&i.start.imply("hour",6)}return i.start.assign("day",o.date()),i.start.assign("month",o.month()+1),i.start.assign("year",o.year()),i.tags.ENCasualDateParser=!0,i}};
},{"../../result":25,"../parser":16,"moment":1}],5:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)([0-9]{4})[\\-\\.]([0-9]{1,2})[\\-\\.]([0-9]{1,2})(?=\\W|$)","i"),YEAR_NUMBER_GROUP=2,MONTH_NUMBER_GROUP=3,DATE_NUMBER_GROUP=4;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,e,r,s){var t=r[0].substr(r[1]),a=r.index+r[1].length,n=new ParsedResult({text:t,index:a,ref:e});return n.start.assign("year",parseInt(r[YEAR_NUMBER_GROUP])),n.start.assign("month",parseInt(r[MONTH_NUMBER_GROUP])),n.start.assign("day",parseInt(r[DATE_NUMBER_GROUP])),moment(n.start.get("month"))>12||moment(n.start.get("month"))<1||moment(n.start.get("day"))>31||moment(n.start.get("day"))<1?null:(n.tags.ENDateFormatParser=!0,n)}};
},{"../../result":25,"../parser":16,"moment":1}],6:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(within|in)\s*([0-9]+|an?)\s*(minutes?|hours?|days?)\s*(?=(?:\W|$))/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,r,a,e){var s=a.index+a[1].length,t=a[0];t=a[0].substr(a[1].length,a[0].length-a[1].length);var n=new ParsedResult({index:s,text:t,ref:r}),i=a[3];i="a"===i||"an"===i?1:parseInt(i);var u=moment(r);return a[4].match(/day/)?(u.add(i,"d"),n.start.assign("year",u.year()),n.start.assign("month",u.month()+1),n.start.assign("day",u.date()),n):(a[4].match(/hour/)?u.add(i,"hour"):a[4].match(/minute/)&&u.add(i,"minute"),n.start.imply("year",u.year()),n.start.imply("month",u.month()+1),n.start.imply("day",u.date()),n.start.assign("hour",u.hour()),n.start.assign("minute",u.minute()),n.tags.ENDeadlineFormatParser=!0,n)}};
},{"../../result":25,"../parser":16,"moment":1}],7:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)([0-9]{4})\\-([0-9]{1,2})\\-([0-9]{1,2})(?:T([0-9]{1,2}):([0-9]{1,2})(?::([0-9]{1,2})(?:\\.(\\d{1,4}))?)?(?:Z|([+-]\\d{2}):?(\\d{2})?)?)?(?=\\W|$)","i"),YEAR_NUMBER_GROUP=2,MONTH_NUMBER_GROUP=3,DATE_NUMBER_GROUP=4,HOUR_NUMBER_GROUP=5,MINUTE_NUMBER_GROUP=6,SECOND_NUMBER_GROUP=7,MILLISECOND_NUMBER_GROUP=8,TZD_HOUR_OFFSET_GROUP=9,TZD_MINUTE_OFFSET_GROUP=10;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,s,e,r){var t=e[0].substr(e[1]),R=e.index+e[1].length,a=new ParsedResult({text:t,index:R,ref:s});if(a.start.assign("year",parseInt(e[YEAR_NUMBER_GROUP])),a.start.assign("month",parseInt(e[MONTH_NUMBER_GROUP])),a.start.assign("day",parseInt(e[DATE_NUMBER_GROUP])),moment(a.start.get("month"))>12||moment(a.start.get("month"))<1||moment(a.start.get("day"))>31||moment(a.start.get("day"))<1)return null;if(null!=e[HOUR_NUMBER_GROUP])if(a.start.assign("hour",parseInt(e[HOUR_NUMBER_GROUP])),a.start.assign("minute",parseInt(e[MINUTE_NUMBER_GROUP])),null!=e[SECOND_NUMBER_GROUP]&&a.start.assign("second",parseInt(e[SECOND_NUMBER_GROUP])),null!=e[MILLISECOND_NUMBER_GROUP]&&a.start.assign("millisecond",parseInt(e[MILLISECOND_NUMBER_GROUP])),null==e[TZD_HOUR_OFFSET_GROUP])a.start.assign("timezoneOffset",0);else{var n=0,_=parseInt(e[TZD_HOUR_OFFSET_GROUP]);null!=e[TZD_MINUTE_OFFSET_GROUP]&&(n=parseInt(e[TZD_MINUTE_OFFSET_GROUP]));var U=60*_;0>U?U-=n:U+=n,a.start.assign("timezoneOffset",U)}return a.tags.ENISOFormatParser=!0,a}};
},{"../../result":25,"../parser":16,"moment":1}],8:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/EN"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tue:2,wednesday:3,wed:3,thursday:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},PATTERN=new RegExp("(\\W|^)(?:(Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun|Mon|Tue|Wed|Thu|Fri|Sat)\\s*,?\\s*)?([0-9]{1,2})(?:st|nd|rd|th)?(?:\\s*(?:to|\\-|until|through|till|\\s)\\s*([0-9]{1,2})(?:st|nd|rd|th)?)?\\s*(?:of)?\\s*(Jan(?:uary|\\.)?|Feb(?:ruary|\\.)?|Mar(?:ch|\\.)?|Apr(?:il|\\.)?|May|Jun(?:e|\\.)?|Jul(?:y|\\.)?|Aug(?:ust|\\.)?|Sep(?:tember|\\.)?|Oct(?:ober|\\.)?|Nov(?:ember|\\.)?|Dec(?:ember|\\.)?)(?:(\\s*[0-9]{2,4}(?![^\\s]\\d))(\\s*BE)?)?(?=\\W|$)","i"),WEEKDAY_GROUP=2,DATE_GROUP=3,DATE_TO_GROUP=4,MONTH_NAME_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(e,t,a,r){var s=new ParsedResult({text:a[0].substr(a[1].length,a[0].length-a[1].length),index:a.index+a[1].length,ref:t}),n=moment(t),d=a[MONTH_NAME_GROUP];d=util.MONTH_OFFSET[d.toLowerCase()];var u=a[DATE_GROUP];u=parseInt(u);var i=null;if(a[YEAR_GROUP]&&(i=a[YEAR_GROUP],i=parseInt(i),a[YEAR_BE_GROUP]?i-=543:100>i&&(i+=2e3)),n.month(d-1),n.date(u),i)n.year(i),s.start.assign("day",n.date()),s.start.assign("month",n.month()+1),s.start.assign("year",n.year());else{n.year(moment(t).year());var o=n.clone().add(1,"y"),y=n.clone().add(-1,"y");Math.abs(o.diff(moment(t)))<Math.abs(n.diff(moment(t)))?n=o:Math.abs(y.diff(moment(t)))<Math.abs(n.diff(moment(t)))&&(n=y),s.start.assign("day",n.date()),s.start.assign("month",n.month()+1),s.start.imply("year",n.year())}if(a[WEEKDAY_GROUP]){var E=a[WEEKDAY_GROUP];E=util.WEEKDAY_OFFSET[E.toLowerCase()],s.start.assign("weekday",E)}return a[DATE_TO_GROUP]&&(s.end=s.start.clone(),s.end.assign("day",parseInt(a[DATE_TO_GROUP]))),s.tags.ENMonthNameLittleEndianParser=!0,s}};
},{"../../result":25,"../../utils/EN":26,"../parser":16,"moment":1}],9:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tue:2,wednesday:3,wed:3,thursday:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},regFullPattern=/(\W|^)((Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun\.?|Mon\.?|Tue\.?|Wed\.?|Thu\.?|Fri\.?|Sat\.?)\s*,?\s*)?(Jan\.?|January|Feb\.?|February|Mar\.?|March|Apr\.?|April|May\.?|Jun\.?|June|Jul\.?|July|Aug\.?|August|Sep\.?|Sept\.?|September|Oct\.?|October|Nov\.?|November|Dec\.?|December)\s*(([0-9]{1,2})(st|nd|rd|th)?\s*(to|\-)\s*)?([0-9]{1,2})(st|nd|rd|th)?(,)?(\s*[0-9]{4})(\s*BE)?(\W|$)/i,regShortPattern=/(\W|^)((Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun\.?|Mon\.?|Tue\.?|Wed\.?|Thu\.?|Fri\.?|Sat\.?)\s*,?\s*)?(Jan\.?|January|Feb\.?|February|Mar\.?|March|Apr\.?|April|May\.?|Jun\.?|June|Jul\.?|July|Aug\.?|August|Sep\.?|Sept\.?|September|Oct\.?|October|Nov\.?|November|Dec\.?|December)\s*(([0-9]{1,2})(st|nd|rd|th)?\s*(to|\-)\s*)?([0-9]{1,2})(st|nd|rd|th)?([^0-9]|$)/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return regShortPattern},this.extract=function(e,r,a,t){var n=new ParsedResult,s=[],u=null,d="",l=a.index;e=e.substr(l);var a=e.match(regFullPattern);if(a&&0==e.indexOf(a[0])){var e=a[0];if(e=e.substring(a[1].length,a[0].length-a[14].length),l+=a[1].length,d=e,e=e.replace(a[2],""),e=e.replace(a[4],a[4]+" "),a[5]&&(e=e.replace(a[5],"")),a[10]&&(e=e.replace(a[10],"")),a[11]&&(e=e.replace(","," ")),a[13]){var i=a[12];i=" "+(parseInt(i)-543),e=e.replace(a[13],""),e=e.replace(a[12],i)}if(e=e.replace(a[9],parseInt(a[9])+""),u=moment(e,"MMMM DD YYYY"),!u)return null;n.start.assign("day",u.date()),n.start.assign("month",u.month()+1),n.start.assign("year",u.year())}else{if(a=e.match(regShortPattern),!a)return null;var e=a[0];if(e=e.substring(a[1].length,a[0].length-a[11].length),l+=a[1].length,d=e,e=e.replace(a[2],""),e=e.replace(a[4],a[4]+" "),a[4]&&(e=e.replace(a[5],"")),u=moment(e,"MMMM DD"),!u)return null;s.push("year"),u.year(moment(r).year());var y=u.clone().add(1,"year"),o=u.clone().add(-1,"year");Math.abs(y.diff(moment(r)))<Math.abs(u.diff(moment(r)))?u=y:Math.abs(o.diff(moment(r)))<Math.abs(u.diff(moment(r)))&&(u=o),n.start.assign("day",u.date()),n.start.assign("month",u.month()+1),n.start.imply("year",u.year())}if(a[3]&&n.start.assign("weekday",DAYS_OFFSET[a[3].toLowerCase()]),a[5]){var h=parseInt(a[9]),m=parseInt(a[6]);n.end=n.start.clone(),n.start.assign("day",m),n.end.assign("day",h);var c=u.clone();u.date(m),c.date(h)}return n.index=l,n.text=d,n.ref=r,n.tags.ENMonthNameMiddleEndianParser=!0,n}};
},{"../../result":25,"../parser":16,"moment":1}],10:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(sun(?:day)?|mon(?:day)|tue(?:sday)|wed(?:nesday)|thu(?:rsday)|fri(?:day)|sat(?:urday))?\s*\,?\s*([0-9]{1,2})[\/\.\-]([0-9]{1,2})([\/\.\-]([0-9]{4}|[0-9]{2}))?(\W|$)/i,DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,wednesday:3,wed:3,thursday:4,thur:4,friday:5,fri:5,saturday:6,sat:6};exports.Parser=function(e){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(e,t,a,r){if("/"!=a[1]&&"/"!=a[7]){var s=a.index+a[1].length,e=a[0].substr(a[1].length,a[0].length-a[7].length),n=new ParsedResult({text:e,index:s,ref:t});if(!e.match(/^\d.\d$/)&&(a[6]||!(a[0].indexOf("/")<0))){var d=null,u=a[6]||moment(t).year()+"",i=a[3],l=a[4];if(i=parseInt(i),l=parseInt(l),u=parseInt(u),(1>i||i>12)&&i>12){if(!(l>=1&&12>=l&&i>=13&&31>=i))return null;var y=i;i=l,l=y}return 1>l||l>31?null:(100>u&&(u>50?u=u+2500-543:u+=2e3),e=i+"/"+l+"/"+u,d=moment(e,"M/D/YYYY"),d&&d.date()==l&&d.month()==i-1?(n.start.assign("day",d.date()),n.start.assign("month",d.month()+1),n.start.assign("year",d.year()),a[2]&&n.start.assign("weekday",DAYS_OFFSET[a[2].toLowerCase()]),n.tags.ENSlashDateFormatParser=!0,n):null)}}}};
},{"../../result":25,"../parser":16,"moment":1}],11:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(?:within\s*)?([0-9]+|an?)\s*(minutes?|hours?|days?)\s*ago(?=(?:\W|$))/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,e,r,a){if(r.index>0&&t[r.index-1].match(/\w/))return null;var t=r[0];t=r[0].substr(r[1].length,r[0].length-r[1].length),index=r.index+r[1].length;var s=new ParsedResult({index:index,text:t,ref:e}),n=r[2];n="a"===n||"an"===n?1:parseInt(n);var i=moment(e);return r[3].match(/day/)?(impliedComponents=[],i.add(-n,"d"),s.start.assign("day",i.date()),s.start.assign("month",i.month()+1),s.start.assign("year",i.year()),s):(r[3].match(/hour/)?i.add(-n,"hour"):r[3].match(/minute/)&&i.add(-n,"minute"),s.start.imply("day",i.date()),s.start.imply("month",i.month()+1),s.start.imply("year",i.year()),s.start.assign("hour",i.hour()),s.start.assign("minute",i.minute()),s.tags.ENTimeAgoFormatParser=!0,s)}};
},{"../../result":25,"../parser":16,"moment":1}],12:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,FIRST_REG_PATTERN=new RegExp("(^|\\s|T)(?:(?:at|from)\\s*)?(\\d{1,4}|noon|midnight)(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),SECOND_REG_PATTERN=new RegExp("^\\s*(\\-|\\~|\\〜|to|\\?)\\s*(\\d{1,4})(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),HOUR_GROUP=2,MINUTE_GROUP=3,SECOND_GROUP=4,AM_PM_HOUR_GROUP=5;exports.Parser=function(){Parser.call(this),this.pattern=function(){return FIRST_REG_PATTERN},this.extract=function(e,r,t,n){if(t.index>0&&e[t.index-1].match(/\w/))return null;var s=moment(r),a=new ParsedResult;a.ref=r,a.index=t.index+t[1].length,a.text=t[0].substring(t[1].length),a.tags.ENTimeExpressionParser=!0,a.start.imply("day",s.date()),a.start.imply("month",s.month()+1),a.start.imply("year",s.year());var i=0,l=0,u=-1;if(null!=t[SECOND_GROUP]){var R=parseInt(t[SECOND_GROUP]);if(R>=60)return null;a.start.assign("second",R)}if("noon"==t[HOUR_GROUP].toLowerCase()?(u=1,i=12):"midnight"==t[HOUR_GROUP].toLowerCase()?(u=0,i=0):i=parseInt(t[HOUR_GROUP]),null!=t[MINUTE_GROUP]?l=parseInt(t[MINUTE_GROUP]):i>100&&(l=i%100,i=parseInt(i/100)),l>=60)return null;if(i>24)return null;if(i>=12&&(u=1),null!=t[AM_PM_HOUR_GROUP]){if(i>12)return null;var P=t[AM_PM_HOUR_GROUP].replace(/\./g,"").toLowerCase();"am"==P&&(u=0,12==i&&(i=0)),"pm"==P&&(u=1,12!=i&&(i+=12))}if(a.start.assign("hour",i),a.start.assign("minute",l),u>=0&&a.start.assign("meridiem",u),t=SECOND_REG_PATTERN.exec(e.substring(a.index+a.text.length)),!t)return a.text.match(/^\d+$/)?null:a;if(t[0].match(/^\s*(\+|\-)\d{3,4}$/))return a;null==a.end&&(a.end=a.start.clone());var i=0,l=0,u=-1;if(null!=t[SECOND_GROUP]){var R=parseInt(t[SECOND_GROUP]);if(R>=60)return null;a.end.assign("second",R)}if(i=parseInt(t[2]),null!=t[MINUTE_GROUP]){if(l=parseInt(t[MINUTE_GROUP]),l>=60)return a}else i>100&&(l=i%100,i=parseInt(i/100));if(l>=60)return null;if(i>24)return null;if(i>=12&&(u=1),null!=t[AM_PM_HOUR_GROUP]){if(i>12)return null;"am"==t[AM_PM_HOUR_GROUP].replace(".","").toLowerCase()&&(u=0,12==i&&(i=0,a.end.isCertain("day")||a.end.imply("day",a.end.get("day")+1))),"pm"==t[AM_PM_HOUR_GROUP].replace(".","").toLowerCase()&&(u=1,12!=i&&(i+=12)),a.start.isCertain("meridiem")||(0==u?(a.start.imply("meridiem",0),12==a.start.get("hour")&&a.start.assign("hour",0)):(a.start.imply("meridiem",1),12!=a.start.get("hour")&&a.start.assign("hour",a.start.get("hour")+12)))}return i>=12&&(u=1),a.text=a.text+t[0],a.end.assign("hour",i),a.end.assign("minute",l),u>=0&&a.end.assign("meridiem",u),a}};
},{"../../result":25,"../parser":16,"moment":1}],13:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)(?:(?:\\,|\\(|\\（)\\s*)?(?:(this|last|next)\\s*)?(Sunday|Sun|Monday|Mon|Tuesday|Tues|Tue|Wednesday|Wed|Thursday|Thurs|Thur|Friday|Fri|Saturday|Sat)(?:\\s*(?:\\,|\\)|\\）))?(?:\\s*(this|last|next)\\s*week)?(?=\\W|$)","i"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tues:2,tue:2,wednesday:3,wed:3,thursday:4,thurs:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},PREFIX_GROUP=2,WEEKDAY_GROUP=3,POSTFIX_GROUP=4;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(e,t,a,r){var s=a.index+a[1].length,e=a[0].substr(a[1].length,a[0].length-a[1].length),n=new ParsedResult({index:s,text:e,ref:t}),d=a[WEEKDAY_GROUP].toLowerCase(),u=DAYS_OFFSET[d];if(void 0===u)return null;var y=moment(t),i=a[PREFIX_GROUP],h=a[POSTFIX_GROUP];if(i||h){var l=i||h;l=l.toLowerCase(),"last"==l?y.day(u-7):"next"==l?y.day(u+7):"this"==l&&y.day(u)}else{var P=y.day();Math.abs(u-7-P)<Math.abs(u-P)?y.day(u-7):Math.abs(u+7-P)<Math.abs(u-P)?y.day(u+7):y.day(u)}return n.start.assign("weekday",u),n.start.imply("day",y.date()),n.start.imply("month",y.month()+1),n.start.imply("year",y.year()),n}};
},{"../../result":25,"../parser":16,"moment":1}],14:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/今日|当日|昨日|明日|今夜|今夕|今晩|今朝/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(r,t,e,a){var s=e.index,r=e[0],i=new ParsedResult({index:s,text:r,ref:t}),n=moment(t),m=n.clone();return"今夜"==r||"今夕"==r||"今晩"==r?(i.start.imply("hour",22),i.start.imply("meridiem",1)):"明日"==r?n.hour()>4&&m.add(1,"day"):"昨日"==r?m.add(-1,"day"):r.match("今朝")&&(i.start.imply("hour",6),i.start.imply("meridiem",0)),i.start.assign("day",m.date()),i.start.assign("month",m.month()+1),i.start.assign("year",m.year()),i.tags.JPCasualDateParser=!0,i}};
},{"../../result":25,"../parser":16,"moment":1}],15:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/JP"),PATTERN=/(?:(同|((昭和|平成)?([0-9０-９]{2,4})))年\s*)?([0-9０-９]{1,2})月\s*([0-9０-９]{1,2})日/i,YEAR_GROUP=2,ERA_GROUP=3,YEAR_NUMBER_GROUP=4,MONTH_GROUP=5,DAY_GROUP=6;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,a,e,r){var s=moment(a),n=new ParsedResult({text:e[0],index:e.index,ref:a}),i=e[MONTH_GROUP];i=util.toHankaku(i),i=parseInt(i);var R=e[DAY_GROUP];if(R=util.toHankaku(R),R=parseInt(R),s.set("date",R),s.set("month",i-1),n.start.assign("day",s.date()),n.start.assign("month",s.month()+1),e[YEAR_GROUP])if(e[YEAR_GROUP].match("同年"))n.start.assign("year",s.year());else{var P=e[YEAR_NUMBER_GROUP];P=util.toHankaku(P),P=parseInt(P),"平成"==e[ERA_GROUP]?P+=1988:"昭和"==e[ERA_GROUP]&&(P+=1925),n.start.assign("year",P)}else{s.year(moment(a).year());var m=s.clone().add(1,"y"),o=s.clone().add(-1,"y");Math.abs(m.diff(moment(a)))<Math.abs(s.diff(moment(a)))?s=m:Math.abs(o.diff(moment(a)))<Math.abs(s.diff(moment(a)))&&(s=o),n.start.assign("day",s.date()),n.start.assign("month",s.month()+1),n.start.imply("year",s.year())}return n.tags.JPStandardParser=!0,n}};
},{"../../result":25,"../../utils/JP":27,"../parser":16,"moment":1}],16:[function(require,module,exports){
function Parser(){this.pattern=function(){return/./i},this.extract=function(e,t,r,n){return null},this.execute=function(e,t,r){for(var n=[],i=this.pattern(),s=e,u=i.exec(s);u;){u.index+=e.length-s.length;var h=this.extract(e,t,u,r);h?(s=e.substring(h.index+h.text.length),n.push(h)):s=e.substring(u.index+1),u=i.exec(s)}return this.refiners&&this.refiners.forEach(function(){n=refiner.refine(n,e,options)}),n}}exports.Parser=Parser;
