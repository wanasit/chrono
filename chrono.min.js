...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/FR"),PATTERN=new RegExp("(\\W|^)(?:les?|la|l'|du|des?)\\s*("+util.INTEGER_WORDS_PATTERN+"|\\d+)?\\s*(prochaine?s?|derni[eè]re?s?|pass[ée]e?s?|pr[ée]c[ée]dents?|suivante?s?)?\\s*(secondes?|min(?:ute)?s?|heures?|jours?|semaines?|mois|trimestres?|années?)\\s*(prochaine?s?|derni[eè]re?s?|pass[ée]e?s?|pr[ée]c[ée]dents?|suivante?s?)?(?=\\W|$)","i"),MULTIPLIER_GROUP=2,MODIFIER_1_GROUP=3,RELATIVE_WORD_GROUP=4,MODIFIER_2_GROUP=5;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,s,a,t){var r=a.index+a[1].length,e=a[0];e=a[0].substr(a[1].length,a[0].length-a[1].length);var n=void 0===a[MULTIPLIER_GROUP]?"1":a[MULTIPLIER_GROUP];n=void 0!==util.INTEGER_WORDS[n]?util.INTEGER_WORDS[n]:parseInt(n);var d=void 0===a[MODIFIER_1_GROUP]?void 0===a[MODIFIER_2_GROUP]?"":a[MODIFIER_2_GROUP].toLowerCase():a[MODIFIER_1_GROUP].toLowerCase();if(d){var i=new ParsedResult({index:r,text:e,ref:s});i.tags.FRRelativeDateFormatParser=!0;var o;switch(!0){case/prochaine?s?/.test(d):case/suivants?/.test(d):o=1;break;case/derni[eè]re?s?/.test(d):case/pass[ée]e?s?/.test(d):case/pr[ée]c[ée]dents?/.test(d):o=-1}var u=n*o,R=moment(s),c=moment(s);R.locale("fr"),c.locale("fr");var m,l=a[RELATIVE_WORD_GROUP];switch(!0){case/secondes?/.test(l):R.add(u,"s"),c.add(o,"s"),m="second";break;case/min(?:ute)?s?/.test(l):R.add(u,"m"),c.add(o,"m"),m="minute";break;case/heures?/.test(l):R.add(u,"h"),c.add(o,"h"),m="hour";break;case/jours?/.test(l):R.add(u,"d"),c.add(o,"d"),m="day";break;case/semaines?/.test(l):R.add(u,"w"),c.add(o,"w"),m="week";break;case/mois?/.test(l):R.add(u,"M"),c.add(o,"M"),m="month";break;case/trimestres?/.test(l):R.add(u,"Q"),c.add(o,"Q"),m="quarter";break;case/années?/.test(l):R.add(u,"y"),c.add(o,"y"),m="year"}if(o>0){var h=R;R=c,c=h}return R.startOf(m),c.endOf(m),i.start.assign("year",R.year()),i.start.assign("month",R.month()+1),i.start.assign("day",R.date()),i.start.assign("minute",R.minute()),i.start.assign("second",R.second()),i.start.assign("hour",R.hour()),i.start.assign("millisecond",R.millisecond()),i.end=i.start.clone(),i.end.assign("year",c.year()),i.end.assign("month",c.month()+1),i.end.assign("day",c.date()),i.end.assign("minute",c.minute()),i.end.assign("second",c.second()),i.end.assign("hour",c.hour()),i.end.assign("millisecond",c.millisecond()),i}}};
