...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tues:2,tue:2,wednesday:3,wed:3,thursday:4,thurs:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},PATTERN=new RegExp("(\\W|^)(?:(?:\\,|\\(|\\（)\\s*)?(?:(this|last|next)\\s*)?(Sunday|Sun|Monday|Mon|Tuesday|Tues|Tue|Wednesday|Wed|Thursday|Thurs|Thur|Friday|Fri|Saturday|Sat)(?:\\s*(?:\\,|\\)|\\）))?(?:\\s*(this|last|next)\\s*week)?(?=\\W|$)","i"),PREFIX_GROUP=2,WEEKDAY_GROUP=3,POSTFIX_GROUP=4;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,t,r,a){var s=r.index+r[1].length,e=r[0].substr(r[1].length,r[0].length-r[1].length),n=new ParsedResult({index:s,text:e,ref:t}),u=r[WEEKDAY_GROUP].toLowerCase(),d=DAYS_OFFSET[u];if(void 0===d)return null;var y=moment(t),i=r[PREFIX_GROUP],h=r[POSTFIX_GROUP];if(i||h){var P=i||h;P=P.toLowerCase(),"last"==P?y.day(d-7):"next"==P?y.day(d+7):"this"==P&&y.day(d)}else{var l=y.day();l>d?y.day(d+7):y.day(d)}return n.start.assign("weekday",d),n.start.imply("day",y.date()),n.start.imply("month",y.month()+1),n.start.imply("year",y.year()),n}};
