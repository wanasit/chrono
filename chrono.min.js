...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(сейчас|сегодня|вчера|ночью|прошлым\s*вечером|сегодня ночью|прошлой\s*ночью|(?:завтра|вчера)\s*|послезавтра|позавчера)(?=\W|$)/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,s,r,a){var t=r[0].substr(r[1].length),e=r.index+r[1].length,n=new ParsedResult({index:e,text:t,ref:s}),i=moment(s),d=i.clone(),o=t.toLowerCase();return"сегодня ночью"===o?(n.start.imply("hour",22),n.start.imply("meridiem",1)):/^завтра/.test(o)?i.hour()>1&&d.add(1,"day"):/^послезавтра/.test(o)?i.hour()>1&&d.add(2,"day"):/^позавчера/.test(o)?d.add(-2,"day"):/^вчера/.test(o)?d.add(-1,"day"):o.match(/прошлой\s*ночью/)?(n.start.imply("hour",0),i.hour()>6&&d.add(-1,"day")):o.match(/прошлым\s*вечером/)?(n.start.imply("hour",15),i.hour()>6&&d.add(-1,"day")):o.match("сейчас")&&(n.start.assign("hour",i.hour()),n.start.assign("minute",i.minute()),n.start.assign("second",i.second()),n.start.assign("millisecond",i.millisecond())),n.start.assign("day",d.date()),n.start.assign("month",d.month()+1),n.start.assign("year",d.year()),n.tags.RUCasualDateParser=!0,n}};
},{"../../result":83,"../parser":45,"moment":2}],54:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/RU"),PATTERN=new RegExp("(\\W|^)(через|спустя)\\s*("+util.INTEGER_WORDS_PATTERN+"|[0-9]+|несколько|одну|один\\s*пол|одну)?\\s*((секунда|секунд|секунды|секунду)|(минут|минуту|минуты)|(часов|час|часа)|(дней|день|дня)|(недель|неделю|неделя|недели)|(месяцев|месяц|месяца)|(лет|год|года))(?=\\W|$)","i"),STRICT_PATTERN=new RegExp("(\\W|^)(через|спустя)\\s*("+util.INTEGER_WORDS_PATTERN+"|[0-9]+|одну(?:r|m)?)\\s*((секунд|секунду|секунды)|(минут|минуту|минуты)|(часов|часа|час)|(дней|день|дня))\\s*(?=\\W|$)","i");exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return this.isStrictMode()?STRICT_PATTERN:PATTERN},this.extract=function(t,e,r,s){var a=r.index+r[1].length,t=r[0];t=r[0].substr(r[1].length,r[0].length-r[1].length);var i=new ParsedResult({index:a,text:t,ref:e});if(r[3]){var n=r[3].toLowerCase();n=void 0!==util.INTEGER_WORDS[n]?util.INTEGER_WORDS[n]:"один"===n||"одну"===n?1:"несколько"===n?3:/пол/.test(n)?.5:parseInt(n)}else/час/i.test(r[4])&&(n=1);var d=moment(e);return/день|дней|дня|недель|неделю|неделя|недели|месяц|месяцев|год|лет|года/i.test(r[4])?(/день|дня|дней/i.test(r[4])?d.add(n,"d"):/недель|неделю|неделя|недели/i.test(r[4])?d.add(7*n,"d"):/месяц|месяцев|месяца/i.test(r[4])?d.add(n,"month"):/год|года|лет/i.test(r[4])&&d.add(n,"year"),i.start.assign("year",d.year()),i.start.assign("month",d.month()+1),i.start.assign("day",d.date()),i):(/часов|час|часа/i.test(r[4])?d.add(n,"hour"):/минут|минуту|минуты/i.test(r[4])?d.add(n,"minute"):/секунд|секунду|секунды/i.test(r[4])&&d.add(n,"second"),i.start.imply("year",d.year()),i.start.imply("month",d.month()+1),i.start.imply("day",d.date()),i.start.imply("hour",d.hour()),i.start.imply("minute",d.minute()),i.start.imply("second",d.second()),i.tags.RUDeadlineFormatParser=!0,i)}};
},{"../../result":83,"../../utils/RU":90,"../parser":45,"moment":2}],55:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/RU"),PATTERN=new RegExp("(\\W|^)([0-9]{1,2})\\s*("+util.MONTH_PATTERN+")\\s*(([0-9]{1,4})?)(?=\\W|$)","i"),DATE_GROUP=2,MONTH_NAME_GROUP=3,YEAR_GROUP=4,YEAR_BE_GROUP=100,WEEKDAY_GROUP=100,DATE_TO_GROUP=100;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,e,a,r){var s=new ParsedResult({text:a[0].substr(a[1].length,a[0].length-a[1].length),index:a.index+a[1].length,ref:e}),n=a[MONTH_NAME_GROUP];n=util.MONTH_OFFSET[n.toLowerCase()];var i=a[DATE_GROUP];i=parseInt(i);var E=null;if(a[YEAR_GROUP]&&(E=a[YEAR_GROUP],E=parseInt(E),a[YEAR_BE_GROUP]?/v/i.test(a[YEAR_BE_GROUP])&&(E=-E):E<100&&(E+=2e3)),E)s.start.assign("day",i),s.start.assign("month",n),s.start.assign("year",E);else{var R=moment(e);R.month(n-1),R.date(i),R.year(moment(e).year());var P=R.clone().add(1,"y"),_=R.clone().add(-1,"y");Math.abs(P.diff(moment(e)))<Math.abs(R.diff(moment(e)))?R=P:Math.abs(_.diff(moment(e)))<Math.abs(R.diff(moment(e)))&&(R=_),s.start.assign("day",i),s.start.assign("month",n),s.start.imply("year",R.year())}if(a[WEEKDAY_GROUP]){var O=a[WEEKDAY_GROUP];O=util.WEEKDAY_OFFSET[O.toLowerCase()],s.start.assign("weekday",O)}return a[DATE_TO_GROUP]&&(s.end=s.start.clone(),s.end.assign("day",parseInt(a[DATE_TO_GROUP]))),s.tags.RUMonthNameLittleEndianParser=!0,s}};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,ParsedComponents=require("../../result").ParsedComponents,FIRST_REG_PATTERN=new RegExp("(^|\\s|T)(?:(?:в|после)\\s*)?(\\d{1,4}|утра|вечера)(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\:|\\：)(\\d{2}))?)?(?:\\s*uhr)?(?:\\s*(утра|вечера|ночи))?(?=\\W|$)","i"),SECOND_REG_PATTERN=new RegExp("^\\s*(\\-|\\–|\\~|\\〜|в|\\?)\\s*(\\d{1,4})(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(утра|вечера|ночи))?(?=\\W|$)","i"),HOUR_GROUP=2,MINUTE_GROUP=3,SECOND_GROUP=4,AM_PM_HOUR_GROUP=5;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return FIRST_REG_PATTERN},this.extract=function(e,t,r,n){if(r.index>0&&e[r.index-1].match(/\w/))return null;var s=moment(t),i=new ParsedResult;i.ref=t,i.index=r.index+r[1].length,i.text=r[0].substring(r[1].length),i.tags.RUTimeExpressionParser=!0,i.start.imply("day",s.date()),i.start.imply("month",s.month()+1),i.start.imply("year",s.year());var a=0,l=0,u=-1;if(null!=r[SECOND_GROUP]){var d=parseInt(r[SECOND_GROUP]);if(d>=60)return null;i.start.assign("second",d)}if(/вечера/i.test(r[HOUR_GROUP])?(u=1,a=12):/утра/i.test(r[HOUR_GROUP])?(u=0,a=0):a=parseInt(r[HOUR_GROUP]),null!=r[MINUTE_GROUP]?l=parseInt(r[MINUTE_GROUP]):a>100&&(l=a%100,a=parseInt(a/100)),l>=60)return null;if(a>24)return null;if(a>=12&&(u=1),null!=r[AM_PM_HOUR_GROUP]){if(a>12)return null;var m=r[AM_PM_HOUR_GROUP].toLowerCase();"утра"===m?(u=0,12==a&&(a=0)):(u=1,12!=a&&(a+=12))}if(i.start.assign("hour",a),i.start.assign("minute",l),u>=0?i.start.assign("meridiem",u):a<12?i.start.imply("meridiem",0):i.start.imply("meridiem",1),!(r=SECOND_REG_PATTERN.exec(e.substring(i.index+i.text.length))))return i.text.match(/^\d+$/)?null:i;if(r[0].match(/^\s*(\+|\-)\s*\d{3,4}$/))return i;null==i.end&&(i.end=new ParsedComponents(null,i.start.date()));var a=0,l=0,u=-1;if(null!=r[SECOND_GROUP]){var d=parseInt(r[SECOND_GROUP]);if(d>=60)return null;i.end.assign("second",d)}if(a=parseInt(r[2]),null!=r[MINUTE_GROUP]){if((l=parseInt(r[MINUTE_GROUP]))>=60)return i}else a>100&&(l=a%100,a=parseInt(a/100));if(l>=60)return null;if(a>24)return null;if(a>=12&&(u=1),null!=r[AM_PM_HOUR_GROUP]){if(a>12)return null;var m=r[AM_PM_HOUR_GROUP][0].toLowerCase();"утра"===m?(u=0,12==a&&(a=0,i.end.isCertain("day")||i.end.imply("day",i.end.get("day")+1))):(u=1,12!=a&&(a+=12)),i.start.isCertain("meridiem")||(0==u?(i.start.imply("meridiem",0),12==i.start.get("hour")&&i.start.assign("hour",0)):(i.start.imply("meridiem",1),12!=i.start.get("hour")&&i.start.assign("hour",i.start.get("hour")+12)))}if(i.text=i.text+r[0],i.end.assign("hour",a),i.end.assign("minute",l),u>=0)i.end.assign("meridiem",u);else{i.start.isCertain("meridiem")&&1==i.start.get("meridiem")&&i.start.get("hour")>a?i.end.imply("meridiem",0):a>12&&i.end.imply("meridiem",1)}return i.end.date().getTime()<i.start.date().getTime()&&i.end.imply("day",i.end.get("day")+1),i}};
},{"../../result":83,"../parser":45,"moment":2}],60:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,DAYS_OFFSET={"воскресенье":0,"вс.":0,"понедельник":1,"пн.":1,"вторник":2,"вт.":2,"среда":3,"среду":3,"ср.":3,"четверг":4,"чт.":4,"пятница":5,"пятницу":5,"пт.":5,"суббота":6,"субботу":6,"сб.":6},PATTERN=new RegExp("(\\W|^)(?:(?:\\,|\\(|\\（)\\s*)?(?:в\\s*?)?(?:(эту|это|этот|прошлый|прошлую|прошлое|прошлая|следующий|следующую|следующее|следующая)\\s*)?("+Object.keys(DAYS_OFFSET).join("|")+")(?:\\s*(?:\\,|\\)|\\）))?(?:\\s*(этой|прошлой|следующей)\\s*недели)?(?=\\W|$)","i"),PREFIX_GROUP=2,WEEKDAY_GROUP=3,POSTFIX_GROUP=4;exports.updateParsedComponent=function(e,t,a,r){var s=moment(t),n=!1,o=s.day();return"прошлый"==r||"прошлую"==r||"прошлое"==r||"прошлая"==r?(s.day(a-7),n=!0):"следующий"==r||"следующую"==r||"следующее"==r||"следующая"==r?(s.day(a+7),n=!0):"эту"==r||"это"==r||"этот"==r?s.day(a):Math.abs(a-7-o)<Math.abs(a-o)?s.day(a-7):Math.abs(a+7-o)<Math.abs(a-o)?s.day(a+7):s.day(a),e.start.assign("weekday",a),n?(e.start.assign("day",s.date()),e.start.assign("month",s.month()+1),e.start.assign("year",s.year())):(e.start.imply("day",s.date()),e.start.imply("month",s.month()+1),e.start.imply("year",s.year())),e},exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,t,a,r){var s=a.index+a[1].length,e=a[0].substr(a[1].length,a[0].length-a[1].length),n=new ParsedResult({index:s,text:e,ref:t}),o=a[WEEKDAY_GROUP].toLowerCase(),d=DAYS_OFFSET[o];if(void 0===d)return null;var i=a[PREFIX_GROUP],P=a[POSTFIX_GROUP],y=i||P;return y=y||"",y=y.toLowerCase(),exports.updateParsedComponent(n,t,d,y),n.tags.RUWeekdayParser=!0,n}};
},{"../../result":83,"../parser":45,"moment":2}],61:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)((утром|обед|в полдень|вечером|в полночь|ночью|ночь))/i,TIME_MATCH=4;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(r,e,t,s){var r=t[0].substr(t[1].length),a=t.index+t[1].length,i=new ParsedResult({index:a,text:r,ref:e});switch(t[TIME_MATCH]||(TIME_MATCH=3),t[TIME_MATCH].toLowerCase()){case"обед":i.start.imply("meridiem",1),i.start.imply("hour",15);break;case"вечером":case"ночью":i.start.imply("meridiem",1),i.start.imply("hour",22);break;case"утром":i.start.imply("meridiem",0),i.start.imply("hour",6);break;case"в полдень":i.start.imply("meridiem",0),i.start.imply("hour",12);break;case"в полночь":case"ночь":i.start.imply("meridiem",1),i.start.imply("hour",24)}return i.tags.RUCasualTimeParser=!0,i}};
