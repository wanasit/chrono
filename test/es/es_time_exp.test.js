...
test("Test - Single Expression", function() {
    ...
    testSingleCase(chrono.es, 'Quedemos a las 6.13 AM', new Date(2012,7,10), (result) => {
...
test("Test - Time Expression's Meridiem imply", function() {
    ...
    testSingleCase(chrono.es, 'hoy de 1pm a 3', new Date(2012,7,10), (result) => {
        expect(result.index).toBe(0);
...
test("Test - Random date + time expression", function() {
    ...
    testSingleCase(chrono.es, 'miércoles 5/1/2013 1115am', (result, text) => {

        expect(result.text).toBe(text);
    });

    testSingleCase(chrono.es, 'viernes 5/3/2013 1230pm', (result, text) => {
    ...
    testSingleCase(chrono.es, 'viernes 6/21/2013 2:30', (result, text) => {
    ...
    testSingleCase(chrono.es, 'Jueves6/20/2013 from 7:00 PM to 10:00 PM', (result, text) => {
    ...
    testSingleCase(chrono.es, 'a las 12', (result, text) => {

        expect(result.text).toBe(text);
    });

    testSingleCase(chrono.es, 'a mediodia', (result, text) => {
    ...
    testSingleCase(chrono.es, 'a medianoche', (result, text) => {
