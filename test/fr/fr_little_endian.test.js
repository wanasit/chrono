...
test("Test - Impossible Dates (Strict Mode)", function() {
    ...
    testUnexpectedResult(chrono.strict, '32 Août 2014', new Date(2012,7,10));

    testUnexpectedResult(chrono.strict, '29 Février 2014', new Date(2012,7,10));

    testUnexpectedResult(chrono.strict, '32 Aout', new Date(2012,7,10));

    testUnexpectedResult(chrono.strict, '29 Fevrier', new Date(2013,7,10))
