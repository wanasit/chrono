...
test("Test - Single Expression", function () {
    ...
    testSingleCase(chrono.de, 'Ich habe vor, am Dienstag nächste Woche freizunehmen', new Date(2015, 3, 18), (result) => {
...
test('Test - forward dates only option', function () {
    ...
    testSingleCase(chrono.de, 'diesen Freitag bis diesen Montag', new Date(2016, 8-1, 4), {forwardDate: true}, (result) => {
        expect(result.index).toBe(0);
