...
test("Test - ng\u00e0y D th\u00e1ng M n\u0103m YYYY (full with ng\u00e0y prefix)", () => {
    testSingleCase(chrono.vi, "Ng\u00e0y 30 th\u00e1ng 4 n\u0103m 1975 l\u00e0 ng\u00e0y gi\u1ea3i ph\u00f3ng.", REF, (r) => {
        expect(r.start.get("year")).toBe(1975);
        expect(r.start.get("month")).toBe(4);
        expect(r.start.get("day")).toBe(30);
    });

    testSingleCase(chrono.vi, "Hi\u1ec7p \u0111\u1ecbnh \u0111\u01b0\u1ee3c k\u00fd ng\u00e0y 27 th\u00e1ng 1 n\u0103m 1973.", REF, (r) => {
...
test("Test - D th\u00e1ng M n\u0103m YYYY (no ng\u00e0y prefix)", () => {
    testSingleCase(chrono.vi, "7 th\u00e1ng 5 n\u0103m 1954 l\u00e0 ng\u00e0y ch\u1ea5m d\u1ee9t tr\u1eadn \u0110i\u1ec7n Bi\u00ean Ph\u1ee7.", REF, (r) => {
...
test("Test - index position is correct", () => {
    testSingleCase(chrono.vi, "S\u1ef1 ki\u1ec7n ng\u00e0y 30 th\u00e1ng 4 n\u0103m 1975 quan tr\u1ecdng.", REF, (r) => {
