...
test("Test - Single Expression", function() {
    ...
    testSingleCase(chrono, '主な株主（2012年3月31日現在）', new Date(2012,8-1,10), (result) => {
    ...
    testSingleCase(chrono, '主な株主（2012年９月3日現在）', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（2020年2月29日現在）', new Date(2019,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（９月3日現在）', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（平成26年12月29日）', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（昭和６４年１月７日）', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（令和元年5月1日）', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（令和2年5月1日）', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（同年7月27日）', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（本年7月27日）', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（今年7月27日）', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(5);
    ...
    testSingleCase(chrono, '主な株主（今年11月27日）', new Date(2012,1-1,10), (result) => {
        expect(result.index).toBe(5);
...
test("Test - Single Expression without year", function() {
    ...
    testSingleCase(chrono, '7月27日', new Date(2012,8-1,10), (result) => {
    ...
    testSingleCase(chrono, '11月27日', new Date(2012,1-1,10), (result) => {
        expect(result.index).toBe(0);
...
test("Test - Range Expression", function() {
    ...
    testSingleCase(chrono, '2013年12月26日-2014年1月7日', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(0);
    ...
    testSingleCase(chrono, '２０１３年１２月２６日ー2014年1月7日', new Date(2012,8-1,10), (result) => {
        expect(result.index).toBe(0);
