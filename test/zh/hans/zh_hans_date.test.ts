...
test("Test - Single Expression", function () {
    ...
    testSingleCase(chrono.zh.hans, "2016年09月03号", new Date(2012, 8 - 1, 10), (result) => {
        expect(result.index).toBe(0);
        expect(result.text).toBe("2016年09月03号");
...
test("Test - Date expression at the beginning of the text", function () {
    ...
    testSingleCase(chrono.zh.hans, "十一月十日", new Date(2012, 8 - 1, 10), (result) => {
        expect(result.index).toBe(0);
    ...
    testSingleCase(chrono.zh.hans, "十二月十日", new Date(2012, 8 - 1, 10), (result) => {
        expect(result.index).toBe(0);
    ...
    testSingleCase(chrono.zh.hans, "十月十日", new Date(2012, 8 - 1, 10), (result) => {
        expect(result.index).toBe(0);
