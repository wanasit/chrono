...
test("Test - Deadline expression at the beginning of the text", function () {
    ...
    testSingleCase(chrono.zh.hans, "十五天后", new Date(2012, 7, 10, 12, 14), (result) => {
        expect(result.index).toBe(0);
        expect(result.text).toBe("十五天后");
    ...
    testSingleCase(chrono.zh.hans, "二十天后", new Date(2012, 7, 10, 12, 14), (result) => {
        expect(result.index).toBe(0);
        expect(result.text).toBe("二十天后");
    ...
    testSingleCase(chrono.zh.hans, "十天后", new Date(2012, 7, 10, 12, 14), (result) => {
        expect(result.index).toBe(0);
        expect(result.text).toBe("十天后");
