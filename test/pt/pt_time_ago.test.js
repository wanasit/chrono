...
test("Test - Single Expression", function() {
    ...
    var text = "há 5 dias, fizemos algo";
    ...
    var text = "há 10 dias, fizemos algo";
    var results = chrono.parse(text, new Date(2012,7,10));
    expect(results.length).toBe(1)
    ...
    if(result){
        ...
        expect(result.index).toBe(0)
        expect(result.text).toBe(' 10 dias')
...
test("Test - Single Expression (Casual)", function() {
    ...
    var text = "há 5 meses, fizemos algo";
    ...
    var text = "há 5 anos, fizemos algo";
    var results = chrono.parse(text, new Date(2012, 8-1,10));
    expect(results.length).toBe(1)
    ...
    var text = "há uma semana, fizemos algo";
